...
const list = [
  { id: 1, name: 'Grazi', text: 'Pessoal', image: <ImageIcon /> },
  { id: 2, name: 'Yohanes', text: 'Trabalho', image: <WorkIcon /> },
  { id: 3, name: 'Yasmin', text: 'Passeio', image: <BeachAccessIcon /> }
]
